        ...
        <div className="flex flex-wrap justify-center -mx-4">
                ...
                <div className="mb-10 wow fadeInUp" data-wow-delay=".1s">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center">
                            <a href="javascript:void(0)" className="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
                <div className="mb-10 wow fadeInUp" data-wow-delay=".2s">
                    <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                        <img src="./img/team-03.png" alt="image" className="w-full rounded-full" />
                        <span className="absolute top-0 left-0 z-[-1]">
                            <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)"
...
export default Team; // Export the component
