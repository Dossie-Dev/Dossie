  ...
  return (
    <section className="min-h-[calc(100vh-5rem)] bg-[#FAFCFF] relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -left-1/2 w-[1000px] h-[1000px] rounded-full bg-primary/5 blur-3xl"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/about">
                <button className="btn btn-outline btn-primary w-full sm:w-auto px-8 gap-2 hover:bg-primary/10">
